...
# TOKEN va KANALLAR
TOKEN = "8870187278:AAFEzsb2UKK6mtaYJmkfmvf1x1xHRIEaBTg"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Salom! Instagramdan video va heshteglarni yuklab olish uchun havola yuboring.")
